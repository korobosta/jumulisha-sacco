...
<div class="admindisplay">
	<form method="POST">
	<div><a href="reports.php">MEMBER REPORTS</a> &nbsp&nbsp&nbsp&nbsp <a href="savingsreport.php">SAVINGS REPORTS</a> &nbsp&nbsp&nbsp&nbsp <a  style="color:teal; background-color: white;padding:10px;" href="loanreports.php">LOAN REPORTS</a><br><br>
